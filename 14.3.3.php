...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl14_3_3` ( `tnumber`, `title`, `description`, `cost`, `fund`) 
...
<title>14.3.3 Maintain ecosystems and their biodiversity (direct work)</title>
...
<div class="main">
  ...
  <div class="input-container">
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT Count(*) AS total FROM `tbl14_3_3`"; // SQL query to fetch all table data
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>14.3.3 Maintain ecosystems and their biodiversity (direct work)</h3>
...
<div class="form-group"><i class="fa fa-bookmark"></i>
      <label for="" class="text-center ">Total number of PPAs that aim to maintain ecosystems and biodiversity:</label>
...
<div class="table-container">
  <h2>Maintain ecosystems and their biodiversity (direct work)</h2>           
  <table class="table table-bordered">
  <thead>
    <tr>
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 10px;">Total number of PPAs that aim to maintain ecosystems and biodiversity:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl14_3_3`"; // SQL query to fetch all table data
            $result = mysqli_query($conn, $query); // sending the query to the database
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl14_3_3`"; // SQL query to fetch all table data
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit_14.3.3.php?update&research_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_14.3.3.php?delete={$id}' class='btn btn-danger'>
