...
if (isset($_POST['submit'])) {
 ...
 // $total_number = $_POST['total_number'];
  ...
  $sql = "INSERT INTO `14.4.3` (`does`,`title`, `description`, `cost`, `source`,`evidence`) VALUES ('$yes','$title','$description', '$cost', '$source', '$evidence')";
...
<div class="main" style="background-color:#C31F33;">
  ...
  <div class="input-container">
    ...
    $query = "SELECT Count(*) AS total  FROM `14.4.3`"; // SQL query to fetch all table data
    ...
    while ($row = mysqli_fetch_assoc($result)) {
       ...
       $totalno= $total;
       $yes = 0;
       $query = "SELECT * FROM `14.4.3`"; // SQL query to fetch all table data
      $result = mysqli_query($conn, $query); // sending the query to the database
      while ($row = mysqli_fetch_assoc($result)) {
        if ($row['does'] == 'yes'){
          $yes++;
...
<!--============================================================================================= 
 ...
 ============================================================================================= -->
  ...
  <div class="content">
    <br>
    <h3>SDG 14.4.3 | Reducing marine pollution(policy)</h3>
    <p>Have a policy on preventing and reducing marine pollution of all kinds,
in particular from land-based activities</p>
...
<div class="mb-2 mt-2">
      <label><i class="fa fa-search"></i> Does your campus have a policy on preventing and reducing marine pollution of all kinds, in particular from land-based activities?</label><br>
...
<div class="table-container">
  <h2>PPAs Implemented In Accordance To Policy</h2>           
  ...
  <!--    <th scope="col" style="width: 30px;">#</th>
      ...
      <th scope="col" style="width: 150px;">Policy</th>
    ...
    <?php
            include "includes/config.php";   // CHANGE THIS WITH YOUR ACTUAL CONNECTION TO DATABASE ex: conn.php
            $query = "SELECT * FROM `14.4.3` ORDER BY `total` DESC"; // SQL query to fetch all table data
            $result = mysqli_query($conn, $query); // sending the query to the database
              ...
              $id = $row['total'];
               ...
               // echo "<td>{$total_number}</td>";
                ...
                echo "<td class ='text-center' style='width:100px'>
                          <a href='edit/edit_14.4.3.php?update&research_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_14.4.3.php?delete={$id}' class='btn btn-danger'>
