...
if (isset($_POST['submit'])) {
 ...
 // $total_number = $_POST['total_number'];
  ...
  $sql = "INSERT INTO `14.5.5` (`does`,`title`, `description`) VALUES ('$yes','$title','$description')";
...
<title>SDG 14.5.5 | Watershed Management Strategy</title>
...
<div class="main" style="background-color:#C31F33;">
  ...
  <div class="input-container">
    ...
    $query = "SELECT Count(*) AS total  FROM `14.5.5`"; // SQL query to fetch all table data
    ...
    while ($row = mysqli_fetch_assoc($result)) {
       ...
       $totalno= $total;
       $yes = 0;
       $query = "SELECT * FROM `14.5.5`"; // SQL query to fetch all table data
      $result = mysqli_query($conn, $query); // sending the query to the database
      while ($row = mysqli_fetch_assoc($result)) {
        if ($row['does'] == 'yes'){
          $yes++;
...
<!--============================================================================================= 
 ...
 ============================================================================================= -->
  ...
  <div class="content">
    <br>
    <h3>SDG 14.5.5 | Watershed Management Strategy</h3>
    <!--remove muna pic 
...
============================================================================================= -->
 ...
 <div class="contentform">
  ...
  <!-- <div class="mb-2 mt-2"><i class="fa fa-search"></i>
    ...
    <label for="title">Title of the Strategy</label>
    <textarea class="form-control" id="title" name="title" rows="5" required></textarea>
</div>
<div class="mb-2 mt-2">
      <label><i class="fa fa-search"></i> Does your campus have a watershed management strategy based on location specific diversity of aquatic species?</label><br>
...
<div class="table-container">
  ...
  <!--    <th scope="col" style="width: 30px;">#</th>
      ...
      <th scope="col" style="width: 150px;">Strategy</th>
    ...
    <?php
            include "includes/config.php";   // CHANGE THIS WITH YOUR ACTUAL CONNECTION TO DATABASE ex: conn.php
            $query = "SELECT * FROM `14.5.5` ORDER BY `total` DESC"; // SQL query to fetch all table data
            $result = mysqli_query($conn, $query); // sending the query to the database
              ...
              $id = $row['total'];
               ...
               // echo "<td>{$total_number}</td>";
                ...
                echo "<td class ='text-center' style='width:100px'>
                          <a href='edit/edit_14.5.5.php?update&research_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_14.5.5.php?delete={$id}' class='btn btn-danger'>
