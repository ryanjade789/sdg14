...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl14_5_2` ( `tnumber`, `title`, `description`, `cost`, `fund`) 
...
<title>14.5.2 Monitoring the health of aquatic ecosystems</title>
...
<div class="main">
  ...
  <div class="input-container">
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT Count(*) AS total FROM `tbl14_5_2`"; // SQL query to fetch all table data
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>14.5.2 Monitoring the health of aquatic ecosystems</h3>
  <p>Monitor the health of aquatic ecosystems.</p>
    <!--remove muna pic 
...
<div class="form-group"><i class="fa fa-bookmark"></i>
      <label for="" class="text-center ">Total number of monitoring PPAs for the health of nearby aquatic ecosystems:</label>
...
<div class="table-container">
  <h2>Monitoring the health of aquatic ecosystems</h2>           
  <table class="table table-bordered">
  <thead>
    <tr>
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 10px;">Total number of monitoring PPAs for the health of nearby aquatic ecosystems:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl14_5_2`"; // SQL query to fetch all table data
            $result = mysqli_query($conn, $query); // sending the query to the database
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl14_5_2`"; // SQL query to fetch all table data
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit_14.5.2.php?update&research_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_14.5.2.php?delete={$id}' class='btn btn-danger'>
