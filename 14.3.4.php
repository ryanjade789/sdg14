...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl14_3_4` ( `tnumber`, `title`, `description`, `cost`, `fund`) 
...
<title>14.3.4 Technologies towards aquatic ecosystem damage prevention (direct work)</title>
...
<div class="main">
  ...
  <div class="input-container">
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT Count(*) AS total FROM `tbl14_3_4`"; // SQL query to fetch all table data
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>14.3.4 Technologies towards aquatic ecosystem damage prevention (direct work)</h3>
  <p>Work directly (research and/or engagement with industries) to maintain and extend existing ecosystems and their biodiversity, of both plants
and animals, especially ecosystems under threat</p>
    <!--remove muna pic 
...
<div class="form-group"><i class="fa fa-bookmark"></i>
      <label for="" class="text-center ">Total number of technologies/practices that aims to minimize or prevent damage to aquatic ecosystems:</label>
      <textarea class="form-control" id="tnumber" name="tnumber" rows="3" required></textarea>
    </div>
<div class="form-group"><i class="fa fa-bookmark"></i>
      <label for="title" class="text-center ">Title of the PPA or Name of Technology:</label>
...
<div class="table-container">
  <h2>Technologies towards aquatic ecosystem damage prevention (direct work)</h2>           
  <table class="table table-bordered">
  <thead>
    <tr>
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 10px;">Total number of technologies/practices that aims to minimize or prevent damage to aquatic ecosystems:</th>
      <th scope="col" style="width: 10px;">Title of the PPA or Name of Technology:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl14_3_4`"; // SQL query to fetch all table data
            $result = mysqli_query($conn, $query); // sending the query to the database
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl14_3_4`"; // SQL query to fetch all table data
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit_14.3.4.php?update&research_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_14.3.4.php?delete={$id}' class='btn btn-danger'>
