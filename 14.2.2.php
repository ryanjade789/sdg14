...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl14_2_2` ( `tnumber`, `title`, `description`, `cost`, `fund`) 
...
<title>14.2.2 Sustainable fisheries (community outreach)</title>
...
<div class="main">
  ...
  <div class="input-container">
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT Count(*) AS total FROM `tbl14_2_2`"; // SQL query to fetch all table data
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>14.2.2 Sustainable fisheries (community outreach)</h3>
  <p>Offer educational programmes or outreach for local or national communities on sustainable management of fisheries , aquaculture
and tourism</p>
    <!--remove muna pic 
...
<div class="table-container">
  ...
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 10px;">Total number of educational programs on sustainable fisheries for the community:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl14_2_2`"; // SQL query to fetch all table data
            $result = mysqli_query($conn, $query); // sending the query to the database
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl14_2_2`"; // SQL query to fetch all table data
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit_14.2.2.php?update&research_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_14.2.2.php?delete={$id}' class='btn btn-danger'>
