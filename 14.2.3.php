...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl14_2_3` ( `tnumber`, `title`, `description`, `cost`, `fund`) 
...
<title>14.2.3 Overfishing (community outreach)</title>
...
<div class="main">
  ...
  <div class="input-container">
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT Count(*) AS total FROM `tbl14_2_3`"; // SQL query to fetch all table data
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>14.2.3 Overfishing (community outreach)</h3>
  <p>Offer educational outreach activities for local or national communities to raise awareness about overfishing, illegal, unreported and
unregulated fishing and destructive fishing practices.</p>
    <!--remove muna pic 
...
<div class="form-group"><i class="fa fa-bookmark"></i>
      <label for="" class="text-center ">Total number of educational programs addressing overfishing:</label>
...
<div class="table-container">
  <h2>Overfishing (community outreach)</h2>           
  <table class="table table-bordered">
  <thead>
    <tr>
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 10px;">Total number of educational programs addressing overfishing:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl14_2_3`"; // SQL query to fetch all table data
            $result = mysqli_query($conn, $query); // sending the query to the database
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl14_2_3`"; // SQL query to fetch all table data
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit_14.2.3.php?update&research_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_14.2.3.php?delete={$id}' class='btn btn-danger'>
