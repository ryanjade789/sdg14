...
if(isset($_GET['research_id']))
    {
     ...
     //...
$query = "SELECT * FROM `tbl14_5_3` WHERE `total_number` = $research_id";
...
<title>SDG 14.5.3 Programmes towards good aquatic stewardship practices</title>
...
<form method="POST">
    ...
    <label for="tnumber" class="text-center">Total number of programs offered towards good aquatic stewardship
practices:</label>
...
<div class="form-group"><i class="fa fa-area-chart"></i>
    <label for="title">Title of the Program:</label>
...
<button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../14.5.3.php';">
