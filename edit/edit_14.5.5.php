...
if(isset($_GET['research_id']))
    {
     ...
     $query = "SELECT * FROM `14.5.5` WHERE `total` = $research_id";
 ...
 if (isset ($_POST['update'])){
    ...
    $yes = $_POST['yes'];
      ...
      // SQL query to update the data in user table where the id = $userid 
        $query ="UPDATE `14.5.5` SET `does` = '$yes', `title` = '$title', `description` = '$description' WHERE `total`= $research_id";
...
<form method="POST">
    ...
    <h3 class="h3text" style="color: red; font-weight: bolder">Strategy</h3>
...
<button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../14.5.5.php';">
