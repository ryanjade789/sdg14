...
if(isset($_GET['research_id']))
    {
     ...
     //...
$query = "SELECT * FROM `tbl14_2_1` WHERE `total_number` = $research_id";
...
<title>SDG 14.2.1 Fresh-water ecosystems (community outreach)</title>
...
<form method="POST">
    ...
    <label for="tnumber" class="text-center">Total number of educational programs on freshwater ecosystems for
community:</label>
...
<button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../14.2.1.php';">
