...
if(isset($_GET['research_id']))
    {
     ...
     //...
$query = "SELECT * FROM `tbl14_2_3` WHERE `total_number` = $research_id";
...
<button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../14.2.3.php';">
