...
if(isset($_GET['research_id']))
    {
     ...
     //...
$query = "SELECT * FROM `tbl14_3_3` WHERE `total_number` = $research_id";
...
<title>SDG 14.3.3 | Maintain ecosystems and their biodiversity (direct work)</title>
...
<form method="POST">
    ...
    <label for="tnumber" class="text-center">Total number of PPAs that aim to maintain ecosystems and
biodiversity:</label>
