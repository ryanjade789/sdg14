...
if(isset($_GET['research_id'])) {
    ...
    die('Error: Research ID is not set.');
}

$query = "SELECT * FROM `tbl14_2_2` WHERE `total_number` = $research_id";
...
<title>SDG 14.2.2 Sustainable fisheries (community outreach)</title>
...
<form method="POST">
    ...
    <label for="tnumber" class="text-center">TTotal number of educational programs on sustainable fisheries for the community:</label>
