...
if(isset($_GET['research_id']))
    {
     ...
     //...
$query = "SELECT * FROM `tbl14_5_2` WHERE `total_number` = $research_id";
...
<title>SDG 14.5.2 Monitoring the health of aquatic ecosystems</title>
...
<form method="POST">
    ...
    <label for="tnumber" class="text-center">Total number of monitoring PPAs for the health of nearby aquatic
ecosystems:</label>
...
<button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../14.5.2.php';">
