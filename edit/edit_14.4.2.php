...
if(isset($_GET['research_id']))
    {
     ...
     $query = "SELECT * FROM `14.4.2` WHERE `total` = $research_id";
 ...
 if (isset ($_POST['update'])){
    ...
    $source = strtoupper($_POST['source']);
      ...
      // SQL query to update the data in user table where the id = $userid 
        $query ="UPDATE `14.4.2` SET `yes` = '$yes', `title` = '$title', `description` = '$description',`cost` = '$cost',`source` = '$source' WHERE `total`= $research_id";
...
<button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../14.4.2.php';">
