...
if(isset($_GET['research_id']))
    {
     ...
     //...
$query = "SELECT * FROM `tbl14_3_1` WHERE `total_number` = $research_id";
...
<title>SDG 14.3.1 | Conservation and sustainable utilization of the oceans (events)</title>
...
<form method="POST">
    ...
    <label for="tnumber" class="text-center">Total number of PPAs that promote conservation and sustainable
utilization of the oceans:</label>
...
<button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../14.3.1.php';">
