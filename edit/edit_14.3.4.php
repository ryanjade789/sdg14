...
if(isset($_GET['research_id']))
    {
     ...
     //...
$query = "SELECT * FROM `tbl14_3_4` WHERE `total_number` = $research_id";
...
<title>SDG 14.3.4 | Technologies towards aquatic ecosystem damage prevention (direct work)</title>
...
<form method="POST">
    ...
    <label for="tnumber" class="text-center">Total number of technologies/practices that aims to minimize or
prevent damage to aquatic ecosystems:</label>
...
<div class="form-group"><i class="fa fa-area-chart"></i>
    <label for="title">Title of the PPA or Name of Technology:</label>
...
<button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../14.3.3.php';">
