...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl14_5_4` ( `tnumber`, `title`, `description`, `cost`, `fund`) 
...
<title>14.5.4 Collaboration for shared aquatic ecosystems</title>
...
<div class="main">
  ...
  <div class="input-container">
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT Count(*) AS total FROM `tbl14_5_4`"; // SQL query to fetch all table data
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>14.5.4 Collaboration for shared aquatic ecosystems</h3>
  <p>Collaborate with the local community in efforts to maintain shared aquatic ecosystems</p>
    <!--remove muna pic 
...
<div class="form-group"><i class="fa fa-bookmark"></i>
      <label for="" class="text-center ">Total number of collaborations with local community to maintain shared aquatic ecosystems:</label>
      <textarea class="form-control" id="tnumber" name="tnumber" rows="3" required></textarea>
    </div>
<div class="form-group"><i class="fa fa-bookmark"></i>
      <label for="title" class="text-center ">Title of the collaboration:</label>
...
<div class="table-container">
  <h2>Collaboration for shared aquatic ecosystems</h2>           
  <table class="table table-bordered">
  <thead>
    <tr>
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 10px;">Total number of collaborations with local community to maintain shared aquatic ecosystems:1</th>
      <th scope="col" style="width: 10px;">Title of the Collaboration</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl14_5_4`"; // SQL query to fetch all table data
            $result = mysqli_query($conn, $query); // sending the query to the database
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl14_5_4`"; // SQL query to fetch all table data
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit_14.5.4.php?update&research_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_14.5.4.php?delete={$id}' class='btn btn-danger'>
